...
import { CloakbrowserConfigSchema, defaultConfig, type CloakbrowserConfig } from "./schema.js"
...
const configSchemaUrl = "https://raw.githubusercontent.com/partment/opencode-cloak-fetch/main/configSchema.json"
...
export async function loadConfig(context: ConfigContext): Promise<CloakbrowserConfig> {
  ...
  return CloakbrowserConfigSchema.parse(merged)
}
